          ...
          create: [
            {
              ...
              instruction: "Przeczytaj uważnie teksty, a następnie wykonaj zadania. Odpowiadaj tylko na podstawie tekstów.",
              timeLimit: 45,
              questions: {
                create: [
                  {
                    ...
                    content: {
                      ...
                      polecenie: "Wyjaśnij sens zdania w kontekście całego fragmentu",
                      wymagania: {
                        minSlow: 30,
                        maxSlow: 100
                      }
                  ...
                  },
                  {
                    order: 2,
                    type: "CUSTOM",
                    question: "Rozstrzygnij, czy w tekście Carla Sagana i w tekście Marty Trepczyńskiej jest mowa o takiej samej przyczynie zainteresowania kosmosem.",
                    points: 2,
                    content: {
                      taskType: TaskType.ROZSTRZYGNIECIE,
                      tekstZrodlowy: ["text-sagan", "text-trepczynska"],
                      polecenie: "Rozstrzygnij i uzasadnij swoją odpowiedź odwołując się do obu tekstów",
                      wymagania: {
                  ...
                  },
                  {
                    order: 3,
                    type: "CUSTOM",
                    question: "Wyjaśnij, dlaczego zgodnie z tekstem Carla Sagana nie możemy po prostu spakować się i wyruszyć na Marsa.",
                    points: 2,
                    content: {
                      taskType: TaskType.POROWNANIE_TEKSTOW,
                      tekstZrodlowy: ["text-sagan", "text-trepczynska"],
                      polecenie: "Porównaj ograniczenia przedstawione w obu tekstach"
                    }
                  },
                  {
                    order: 4,
                    ...
                    points: 1,
                    content: {
                      taskType: TaskType.PRAWDA_FALSZ,
                      statements: [
                        {
                  ...
                  },
                  {
                    order: 5,
                    type: "CUSTOM",
                    question: "Na podstawie obu tekstów napisz notatkę syntetyzującą na temat: odkrywanie kosmosu jako potrzeba człowieka.",
                    points: 4,
                    content: {
                      taskType: TaskType.NOTATKA_SYNTETYZUJACA,
                      tekstZrodlowy: ["text-sagan", "text-trepczynska"],
                      polecenie: "Twoja wypowiedź powinna liczyć 60-90 wyrazów.",
                      wymagania: {
                        minSlow: 60,
                        maxSlow: 90
                      }
                ...
                create: [
                  {
                    order: 6,
                    type: "CUSTOM",
                    question: "Do których postaci mitologicznych nawiązują fragmenty wierszy?",
                    points: 1,
                    content: {
                  ...
                  },
                  {
                    order: 7,
                    type: "CUSTOM",
                    question: "Wyjaśnij, czym się różni postawa życiowa zalecana w Rozmowie Mistrza Polikarpa ze Śmiercią od postawy w Wiośnie Morsztyna.",
                    points: 1,
                    content: {
                      ...
                      tematy: [
                        {
                          ...
                          polecenie: "W pracy odwołaj się do lektury obowiązkowej, innego utworu literackiego oraz wybranych kontekstów.",
                          wymagania: {
                            minSlow: 400,
